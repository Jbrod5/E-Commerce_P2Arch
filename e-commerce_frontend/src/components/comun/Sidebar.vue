<template>
  ...
  >
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        ...
        >
          ...
          <span
            v-if="carritoStore.cantidadProductos > 0"
    ...
    <div class="mt-auto">
      <!-- Boton para ir al perfil del vendedor :3 -->
      <router-link
        to="/vendedor/perfil"
        class="d-flex flex-column align-items-start mb-3 border-bottom border-secondary pb-2 text-decoration-none"
      >
